...
function App() {
  ...
  return (
    <div className='bg-green-500 w-screen h-screen'>
        ...
        <div>
          <button className='bg-black text-white px-4 py-2 rounded-full mt-8 mx-auto block transition-all font-semibold hover:bg-gray-600'>Generate Playlist</button>
        </div>
    </div>
  )
}
